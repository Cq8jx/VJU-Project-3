---
id: DHVN-HD-1534
title: 5. Guidelines for Theses and Graduation Projects
...
- 5. Guide faculties, training programmes, supervisors and students in carrying out the related tasks according to the thesis/project implementation schedule (Appendix 1).
...
- At the time of the defence: students must have completed all major-specific modules in the curriculum (excluding the thesis/project module); must obtain a plagiarism check result from the Office of Testing and 2. Quality Assurance showing a duplication rate below 20%; and must submit the defence application signed by the supervisor (Guidance Log, Appendix 3).
...
- Students revise the thesis/project based on the committee’s conclusions and submit the digital file to the Office of Testing and 2. Quality Assurance for a final plagiarism check. If the similarity index is 20% or higher, the student continues revising as instructed. If it is below 20%, the student completes the Revision Confirmation Form (Appendix 3) signed by the student, supervisor and committee chair.
