...
This page may temporarily contain broken links while updates are in progress. If that happens, please refer directly to the repository at https://github.com/Cq8jx/VJU-Project-3 to access each regulation file.
...
<details class="collection-toggle" open>
  <summary>3. University Regulations ({{ reg_count }})</summary>
...
- [GWS and Gemini Usage 5. Guide]({{ '/5. Guide/GWS and Gemini Usage 5. Guide - English.html' | relative_url }})
- [Professional Manner and Workstyle 5. Guide]({{ '/5. Guide/Professional Manner and Workstyle - English.html' | relative_url }})
- [Google Meet 5. Guide]({{ '/5. Guide/Google Meet/Google Meet 5. Guide - English.html' | relative_url }})
