...
<details class="collection-toggle" open>
  <summary>3. 大学規程 ({{ reg_count_ja }})</summary>
...
{% assign testing_docs_ja = site.data.education_testing_ja %}
{% for doc in testing_docs_ja %}
- [{%- include doc-label.html doc=doc -%}]({{ doc.url | relative_url }})
{% endfor %}

## ガイドライン

- [GWS と Gemini 利用ガイド]({{ '/5. Guide/GWS and Gemini Usage 5. Guide - Japanese.html' | relative_url }})
- [Professional Manner and Workstyle ガイド]({{ '/5. Guide/Professional Manner and Workstyle - Japanese.html' | relative_url }})
- [Google Meet ガイド]({{ '/5. Guide/Google Meet/Google Meet 5. Guide - Japanese.html' | relative_url }})
